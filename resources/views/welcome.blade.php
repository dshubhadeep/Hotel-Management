...
.bgimg-2 {
    background-image: url({{ asset('img/hotel1.jpg') }});
    min-height: 200px;
}
.bgimg-3 {
...
<div class="w3-top">
  <ul class="w3-navbar w3-text-white" id="myNavbar">
    ...
    <li class="w3-hide-small w3-right">
      <a href="/login" class="w3-padding-large w3-red w3-hover-text-black">LOG IN & BOOK ROOM</a>
    </li>
  </ul>
</div>
...
<div class="bgimg-1 w3-opacity w3-display-container">
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-xlarge w3-white w3-xlarge w3-wide w3-animate-opacity"> <img src="{{ asset('img/logo.png') }}" height="45">HOTEL <span class="w3-hide-small"> TRANSYLVANIA </span> </span>
  </div>
</div>
...
<div class="w3-col m4 w3-container w3-section"> <div class="w3-large w3-margin-bottom"><img src="{{ asset('img/1.jpg') }}"></div></div></div>
...
<div class="w3-col m4 w3-container w3-section"> <div class="w3-large w3-margin-bottom"><img src="{{ asset('img/2.jpg') }}"></div></div></div>
...
<li>Enjoy Seasonal Food and Cocktail Selections</li>
    ...
    <div class="w3-col m4 w3-container w3-section"> <div class="w3-large w3-margin-bottom"><img src="{{ asset('img/3.jpg') }}"></div></div></div>
...
<li>Temperature-controlled Pool</li>
    ...
    <div class="w3-col m4 w3-container w3-section"> <div class="w3-large w3-margin-bottom"><img src="{{ asset('img/4.jpg') }}"></div></div></div>
...
<li>Free Wi-Fi</li>
    ...
    <div class="w3-col m4 w3-container w3-section"> <div class="w3-large w3-margin-bottom"><img src="{{ asset('img/5.jpg') }}"></div></div></div>
